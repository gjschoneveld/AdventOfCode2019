...
namespace Day21
{
    ...
    class Program
    {
        static BigInteger Run(List<BigInteger> program, string[] script, string mode)
        {
        ...
        static void Main()
        {
            ...
            var script1 = File.ReadAllLines("script1.txt");
            var answer1 = Run(program, script1, "WALK");

            Console.WriteLine($"Answer 1: {answer1}");

            var script2 = File.ReadAllLines("script2.txt");
            var answer2 = Run(program, script2, "RUN");
